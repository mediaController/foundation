        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/mediacontroller/foundation/")
                    ...
                    developers {
                        developer {
                            id.set("mediacontroller")
                            name.set("mediacontroller")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/mediacontroller/foundation.git")
                        developerConnection.set("scm:git:ssh://github.com/mediacontroller/foundation.git")
                        url.set("https://github.com/mediacontroller/foundation/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/mediacontroller/foundation/issues")
                    }
                }
            }
        }
